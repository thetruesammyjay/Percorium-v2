...
export default function GiftsPage() {
  ...
  const submit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    if (!assetMint) {
      setError("Choose an approved asset.");
      return;
    }
